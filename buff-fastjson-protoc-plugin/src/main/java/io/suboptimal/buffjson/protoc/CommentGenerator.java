 ...
 * implements {@code GeneratedComments}. Extracts leading comments from
...
final class CommentGenerator {
	...
	static String generate(FileDescriptorProto fileProto, String javaPackage, String className) {
		...
		sb.append("import io.suboptimal.buffjson.GeneratedComments;\n\n");
		sb.append("public final class ").append(className).append(" implements GeneratedComments {\n\n");

...
class Proto3JsonConformanceTest {
    ...
    private void assertMatchesReference(Message message) throws Exception {
        ...
        assertEquals(expected, actual,
                "Mismatch for " + message.getDescriptorForType().getFullName());
    }
    ...
    class ScalarTypes {
        ...
        void allScalarTypes() throws Exception {
            assertMatchesReference(TestAllScalars.newBuilder()
                    .setOptionalInt32(42)
                    .setOptionalInt64(123456789012345L)
                    .setOptionalUint32(100)
                    .setOptionalUint64(999999999999L)
                    .setOptionalSint32(-42)
                    .setOptionalSint64(-123456789012345L)
                    .setOptionalFixed32(100)
                    .setOptionalFixed64(999999999999L)
                    .setOptionalSfixed32(-100)
                    .setOptionalSfixed64(-999999999999L)
                    .setOptionalFloat(3.14f)
                    .setOptionalDouble(2.718281828)
                    .setOptionalBool(true)
                    .setOptionalString("hello world")
                    .setOptionalBytes(ByteString.copyFromUtf8("binary data"))
                    .build());
        }
        ...
        void integerBoundaries() throws Exception {
            assertMatchesReference(TestAllScalars.newBuilder()
                    .setOptionalInt32(Integer.MAX_VALUE)
                    .setOptionalInt64(Long.MAX_VALUE)
                    .setOptionalUint32(-1) // unsigned max = 4294967295
                    .setOptionalUint64(-1L) // unsigned max
                    .setOptionalSint32(Integer.MIN_VALUE)
                    .setOptionalSint64(Long.MIN_VALUE)
                    .build());
        }
        ...
        void negativeNumbers() throws Exception {
            assertMatchesReference(TestAllScalars.newBuilder()
                    ...
                    .setOptionalInt64(-1L)
                    .setOptionalSint32(-1)
                    .setOptionalSint64(-1L)
                    .setOptionalSfixed32(-1)
                    .setOptionalSfixed64(-1L)
                    .setOptionalFloat(-3.14f)
                    .setOptionalDouble(-2.718)
                    .build());
        }
        ...
        void specialFloatValues() throws Exception {
            assertMatchesReference(TestAllScalars.newBuilder()
                    .setOptionalFloat(Float.NaN)
                    .setOptionalDouble(Double.NaN)
                    .build());
        }
        ...
        void infinityValues() throws Exception {
            assertMatchesReference(TestAllScalars.newBuilder()
                    .setOptionalFloat(Float.POSITIVE_INFINITY)
                    .setOptionalDouble(Double.NEGATIVE_INFINITY)
                    .build());
        }
        ...
        void verySmallFloat() throws Exception {
            assertMatchesReference(TestAllScalars.newBuilder()
                    .setOptionalFloat(Float.MIN_VALUE)
                    .setOptionalDouble(Double.MIN_VALUE)
                    .build());
        }
        ...
        void unicodeStrings() throws Exception {
            assertMatchesReference(TestAllScalars.newBuilder()
                    .setOptionalString("Hello \u4e16\u754c") // Chinese
                    .build());
        }
        ...
        void bytesWithPaddingEdgeCases() throws Exception {
            ...
            assertMatchesReference(TestAllScalars.newBuilder()
                    .setOptionalBytes(ByteString.copyFrom(new byte[]{0x01}))
                    .build());
            // 2 bytes -> 3 base64 chars + padding
            assertMatchesReference(TestAllScalars.newBuilder()
                    .setOptionalBytes(ByteString.copyFrom(new byte[]{0x01, 0x02}))
                    .build());
            // 3 bytes -> 4 base64 chars, no padding
            assertMatchesReference(TestAllScalars.newBuilder()
                    .setOptionalBytes(ByteString.copyFrom(new byte[]{0x01, 0x02, 0x03}))
                    .build());
        }
    }
    ...
    class RepeatedFields {
        ...
        void repeatedScalars() throws Exception {
            assertMatchesReference(TestRepeatedScalars.newBuilder()
                    .addRepeatedInt32(1).addRepeatedInt32(2).addRepeatedInt32(3)
                    .addRepeatedInt64(100L).addRepeatedInt64(200L)
                    .addRepeatedUint32(10).addRepeatedUint32(20)
                    .addRepeatedUint64(1000L)
                    .addRepeatedSint32(-1).addRepeatedSint32(1)
                    .addRepeatedSint64(-100L).addRepeatedSint64(100L)
                    .addRepeatedFixed32(42)
                    .addRepeatedFixed64(42L)
                    .addRepeatedSfixed32(-42)
                    .addRepeatedSfixed64(-42L)
                    .addRepeatedFloat(1.1f).addRepeatedFloat(2.2f)
                    .addRepeatedDouble(1.1).addRepeatedDouble(2.2)
                    .addRepeatedBool(true).addRepeatedBool(false)
                    .addRepeatedString("a").addRepeatedString("b")
                    .addRepeatedBytes(ByteString.copyFromUtf8("x"))
                    .build());
        }
    ...
    class Enums {
        ...
        void defaultEnumOmitted() throws Exception {
            assertMatchesReference(TestNesting.newBuilder()
                    .setEnumValue(TestEnum.TEST_ENUM_UNSPECIFIED)
                    .build());
        }
        ...
        void repeatedEnums() throws Exception {
            assertMatchesReference(TestNesting.newBuilder()
                    .addRepeatedEnum(TestEnum.TEST_ENUM_FOO)
                    .addRepeatedEnum(TestEnum.TEST_ENUM_BAR)
                    .addRepeatedEnum(TestEnum.TEST_ENUM_BAZ)
                    .build());
        }
    }
    ...
    class NestedMessages {
        ...
        void nestedMessage() throws Exception {
            assertMatchesReference(TestNesting.newBuilder()
                    .setNested(NestedMessage.newBuilder().setValue(42).setName("test"))
                    .build());
        }
        ...
        void recursiveMessage() throws Exception {
            assertMatchesReference(TestRecursive.newBuilder()
                    .setValue(1)
                    .setChild(TestRecursive.newBuilder()
                            .setValue(2)
                            .setChild(TestRecursive.newBuilder()
                                    .setValue(3)))
                    .build());
    ...
    class OneofFields {
        ...
        void oneofInt() throws Exception {
            assertMatchesReference(TestOneof.newBuilder()
                    .setName("test")
                    .setIntValue(42)
                    .build());
        }
        ...
        void oneofMessage() throws Exception {
            assertMatchesReference(TestOneof.newBuilder()
                    .setMessageValue(NestedMessage.newBuilder().setValue(42))
                    .build());
        }
        ...
        void oneofEnum() throws Exception {
            assertMatchesReference(TestOneof.newBuilder()
                    .setEnumValue(TestEnum.TEST_ENUM_BAR)
                    .build());
        }
    ...
    class MapFields {
        ...
        void stringKeyMaps() throws Exception {
            assertMatchesReference(TestMaps.newBuilder()
                    .putStringToString("key1", "value1")
                    .putStringToString("key2", "value2")
                    .putStringToInt32("count", 42)
                    .putStringToInt64("big", 999999999999L)
                    .putStringToFloat("pi", 3.14f)
                    .putStringToDouble("e", 2.718)
                    .putStringToBool("flag", true)
                    .putStringToBytes("data", ByteString.copyFromUtf8("binary"))
                    .putStringToMessage("msg", NestedMessage.newBuilder().setValue(1).build())
                    .putStringToEnum("status", TestEnum.TEST_ENUM_FOO)
                    .build());
        }
        ...
        void intKeyMaps() throws Exception {
            assertMatchesReference(TestMaps.newBuilder()
                    .putInt32ToString(1, "one")
                    .putInt32ToString(2, "two")
                    .putInt64ToString(100L, "hundred")
                    .putUint32ToString(42, "answer")
                    .putUint64ToString(999L, "big")
                    .putSint32ToString(-1, "negative")
                    .putSint64ToString(-100L, "neg hundred")
                    .putFixed32ToString(10, "fixed")
                    .putFixed64ToString(20L, "fixed64")
                    .putSfixed32ToString(-10, "sfixed")
                    .putSfixed64ToString(-20L, "sfixed64")
                    .build());
        }
    ...
    class TimestampTests {
        ...
        void timestamp() throws Exception {
            assertMatchesReference(TestTimestamp.newBuilder()
                    .setValue(Timestamp.newBuilder().setSeconds(1711627200).setNanos(0))
                    .build());
        }
        ...
        void timestampWithNanos() throws Exception {
            assertMatchesReference(TestTimestamp.newBuilder()
                    .setValue(Timestamp.newBuilder().setSeconds(1711627200).setNanos(123456000))
                    .build());
        }
        ...
        void timestampWithFullNanos() throws Exception {
            assertMatchesReference(TestTimestamp.newBuilder()
                    .setValue(Timestamp.newBuilder().setSeconds(1711627200).setNanos(123456789))
                    .build());
        }
        ...
        void timestampEpoch() throws Exception {
            assertMatchesReference(TestTimestamp.newBuilder()
                    .setValue(Timestamp.newBuilder().setSeconds(0).setNanos(0))
                    .build());
        }
        ...
        void timestampBeforeEpoch() throws Exception {
            assertMatchesReference(TestTimestamp.newBuilder()
                    .setValue(Timestamp.newBuilder().setSeconds(-1).setNanos(0))
                    .build());
        }
    }
    ...
    class DurationTests {
        ...
        void duration() throws Exception {
            assertMatchesReference(TestDuration.newBuilder()
                    .setValue(Duration.newBuilder().setSeconds(3600).setNanos(0))
                    .build());
        }
        ...
        void durationWithNanos() throws Exception {
            assertMatchesReference(TestDuration.newBuilder()
                    .setValue(Duration.newBuilder().setSeconds(1).setNanos(500000000))
                    .build());
        }
        ...
        void durationZero() throws Exception {
            assertMatchesReference(TestDuration.newBuilder()
                    .setValue(Duration.newBuilder().setSeconds(0).setNanos(0))
                    .build());
        }
    }
    ...
    class FieldMaskTests {
        ...
        void emptyFieldMask() throws Exception {
            assertMatchesReference(TestFieldMask.newBuilder()
                    .setValue(FieldMask.getDefaultInstance())
                    .build());
        }
    }
    ...
    class StructTests {
        ...
        void valueNumber() throws Exception {
            assertMatchesReference(TestStruct.newBuilder()
                    .setValue(Value.newBuilder().setNumberValue(3.14))
                    .build());
        }
        ...
        void valueBool() throws Exception {
            assertMatchesReference(TestStruct.newBuilder()
                    .setValue(Value.newBuilder().setBoolValue(false))
                    .build());
        }
        ...
        void emptyStruct() throws Exception {
            assertMatchesReference(TestStruct.newBuilder()
                    .setStructValue(Struct.getDefaultInstance())
                    .build());
        }
    }
    ...
    class WrapperTests {
        ...
        void int32Wrapper() throws Exception {
            assertMatchesReference(TestWrappers.newBuilder()
                    .setInt32Value(Int32Value.of(42))
                    .build());
        }
        ...
        void uint32Wrapper() throws Exception {
            assertMatchesReference(TestWrappers.newBuilder()
                    .setUint32Value(UInt32Value.of(100))
                    .build());
        }
        ...
        void int64Wrapper() throws Exception {
            assertMatchesReference(TestWrappers.newBuilder()
                    .setInt64Value(Int64Value.of(123456789012345L))
                    .build());
        }
        ...
        void uint64Wrapper() throws Exception {
            assertMatchesReference(TestWrappers.newBuilder()
                    .setUint64Value(UInt64Value.of(999999999999L))
                    .build());
        }
        ...
        void floatWrapper() throws Exception {
            assertMatchesReference(TestWrappers.newBuilder()
                    .setFloatValue(FloatValue.of(3.14f))
                    .build());
        }
        ...
        void doubleWrapper() throws Exception {
            assertMatchesReference(TestWrappers.newBuilder()
                    .setDoubleValue(DoubleValue.of(2.718))
                    .build());
        }
        ...
        void stringWrapper() throws Exception {
            assertMatchesReference(TestWrappers.newBuilder()
                    .setStringValue(StringValue.of("hello"))
                    .build());
        }
        ...
        void bytesWrapper() throws Exception {
            assertMatchesReference(TestWrappers.newBuilder()
                    .setBytesValue(BytesValue.of(ByteString.copyFromUtf8("binary")))
                    .build());
        }
        ...
        void allWrappers() throws Exception {
            assertMatchesReference(TestWrappers.newBuilder()
                    .setInt32Value(Int32Value.of(1))
                    .setUint32Value(UInt32Value.of(2))
                    .setInt64Value(Int64Value.of(3L))
                    .setUint64Value(UInt64Value.of(4L))
                    .setFloatValue(FloatValue.of(5.0f))
                    .setDoubleValue(DoubleValue.of(6.0))
                    .setBoolValue(BoolValue.of(true))
                    .setStringValue(StringValue.of("eight"))
                    .setBytesValue(BytesValue.of(ByteString.copyFromUtf8("nine")))
                    .build());
        }
    }
    ...
    class ExplicitPresence {
        ...
        void optionalFieldSet() throws Exception {
            assertMatchesReference(TestOptionalFields.newBuilder()
                    .setOptionalInt32(42)
                    .setOptionalString("present")
                    .setOptionalBool(true)
                    .setOptionalEnum(TestEnum.TEST_ENUM_FOO)
                    .build());
        }
        ...
        void optionalFieldSetToDefault() throws Exception {
            ...
            assertMatchesReference(TestOptionalFields.newBuilder()
                    ...
                    .setOptionalEnum(TestEnum.TEST_ENUM_UNSPECIFIED)
                    .build());
        }
    ...
    class CustomJsonName {
        ...
        void customJsonName() throws Exception {
            assertMatchesReference(TestCustomJsonName.newBuilder()
                    .setValue(42)
                    .setName("test")
                    .build());
        }
